                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Danh sách bình luận nhật ký của <a href="{{ route('my_diaryIndex', $value->User->id)}}">{{$value->User->name}}</a></h5>
                                ...
                                @foreach ($value->Comments as $cmt)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-11">
                                            {{-- phần này thêm các chức năng sau  --}}
                                            <div class="mt-3 ms-2">
                                                <p><span  style="color:blue ">{{ $cmt->User->name }} </span> &ensp;{{ \Carbon\Carbon::parse($cmt->created_at)->timezone('Asia/Ho_Chi_Minh')->format('H:i') }}&ensp;&nbsp;{{ \Carbon\Carbon::parse($cmt->created_at)->timezone('Asia/Ho_Chi_Minh')->format('d/m/Y') }}</p>
